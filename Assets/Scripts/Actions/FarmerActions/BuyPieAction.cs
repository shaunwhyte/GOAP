...
public class BuyPieAction : GoapAction
{
    private bool bought = false;
    private PieShopOne targetChoppingBlock; // what food we eat;
    ...
    public BuyPieAction()
    {
        ...
        addPrecondition("pieShopOneOpen", true); //must have available funds for pie.
